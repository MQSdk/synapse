...
class UserDirectorySearchModule:
    ...
    def __init__(self, hs: "HomeServer", database_engine_type: BaseDatabaseEngine):
        self.database_engine_type = database_engine_type
    ...
    def get_search_query_ordering(self) -> Tuple[str, Tuple]:
        ...
        if self.custom_module is None or not hasattr(
            ...
            if self.database_engine_type == PostgresEngine:
            ...
            elif self.database_engine_type == Sqlite3Engine:
                # We order by rank and then if a user has profile info.
                return (
                    """
        ...
        return self.custom_module.get_search_query_ordering()
